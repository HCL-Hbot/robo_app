...
public:
    ...
    /**
     * @brief Start receiving RTP streams.
     * 
     * This method starts the GStreamer pipeline and begins calling the provided
     * callback with received samples.
     * 
     * @param callback The callback function to call with received samples.
     */
    void start(SampleCallback callback);

    /**
     * @brief Stop receiving RTP streams.
     * 
     * This method stops the GStreamer pipeline.
     */
    void stop();
